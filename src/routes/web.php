...
Route::get('/admin/attendance/export', [\App\Http\Controllers\AdminController::class, 'exportCsv'])->name('admin.attendance.export');
Route::middleware('auth')->get('/admin/attendance/{id}',[AdminController::class, 'showDetail'])->name('admin.attendance.show');
Route::middleware('auth')->post('/admin/attendance', [AdminController::class, 'store'])->name('admin.attendance.store');
